...
exports.logoutController = exports.getProfile = exports.handleChangePassword = exports.resetPasswordController = exports.forgotPassword = exports.verifyEmailController = exports.refreshToken = exports.loginAdminHandler = void 0;
...
const refreshToken = async (req, res) => {
    try {
        ...
        const { accessToken, refreshToken } = await (0, auth_service_1.refreshAccessToken)(token);
...
const logoutController = async (req, res) => {
    try {
        const userId = req.user?.sub;
        await (0, auth_service_1.logout)(Number(userId));
...
async function updateProfileController(req, res) {
    ...
    const dto = req.body;
    const serviceResp = await (0, auth_service_1.updateUserProfile)(userId, dto);
    res
