...
const historique_controller_1 = require("../controllers/historique.controller");
 ...
 */
router.get("/", authMiddleware_1.authMiddleware, requireAdmin_1.requireAdmin, (0, asyncWrapper_1.asyncWrapper)(historique_controller_1.getAllHistoriquesController));
/**
 * @swagger
 * /historiques/{id}:
 *   get:
 ...
 */
router.get("/:id", authMiddleware_1.authMiddleware, requireAdmin_1.requireAdmin, (0, asyncWrapper_1.asyncWrapper)(historique_controller_1.getHistoriqueByIdController));
/**
 * @swagger
 * /historiques/old:
 *   delete:
 ...
 *         description: Accès interdit (permissions insuffisantes)
 */
router.delete("/old", authMiddleware_1.authMiddleware, requireAdmin_1.requireAdmin, (0, asyncWrapper_1.asyncWrapper)(historique_controller_1.deleteOldHistoriquesController));
/**
 * @swagger
 * /historiques/{id}:
 *   delete:
 ...
 *         description: Historique non trouvé
 */
router.delete("/:id", authMiddleware_1.authMiddleware, requireAdmin_1.requireAdmin, (0, asyncWrapper_1.asyncWrapper)(historique_controller_1.deleteHistoriqueByIdController));
